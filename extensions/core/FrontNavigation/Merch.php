<?php
/**
 * @brief		Front Navigation Extension: Merch
...
/**
 * Front Navigation Extension: Merch
 */
class _Merch extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
	/**
	...
	{
		return \IPS\Member::loggedIn()->language()->addToStack('frontnavigation_printfulintegration');
	}
