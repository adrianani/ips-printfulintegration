<?php
/**
 * @brief		Editor Extension: ProductDesc
...
namespace IPS\printfulintegration\extensions\core\EditorLocations;
...
class _ProductDesc
{
	...
	{
		return $member->canAccessModule( \IPS\Application\Module::get( 'printfulintegration', 'overview' ) );
	}
	...
	{
		return \IPS\Http\Url::internal("app=printfulintegration&module=store&controller=product&id={$id1}", 'front', 'merch_product');
	}
