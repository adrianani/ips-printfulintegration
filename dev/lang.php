...
$lang = array(
    ...
    'menu__printfulintegration_overview_emails' => "Messages",
    'printful_email_campaign' => "Automated messages",
    'pe_title' => "Subject",
    'pe_type' => "Type",
    ...
    'pe_type_email' => "Email",
    'pe_type_pm' => "Personal Message",
    'pe_send_type' => "Send as",
    'pe_sender_member' => "From",
    'pe_sender_member_desc' => "Who sent this PM?",
    'pe_sender_email' => "From",
    'pe_sender_email_desc' => "Email address to use when sending the message",
    'printful_product_disabled' => "This product is currently disabled but shown to you because you are an administrator",
    'printful_checkout_login' => "Login to checkout",
    'printful_checkout_register' => "Sign up",
    'printful_address_error' => "The address you've entered in missing some data. Enter a correct address, street and postcode!",
    // emails
    'mailsub__printfulintegration_thanksEmail' => '{$title}',
    // widgets
    'block_printfulFeaturedItems' => "Featured merch items",
    'block_printfulFeaturedItems_desc' => "Create a block containing featured items from the merch store.",
    'pfi_title' => "Block title",
    'pfi_items' => "Items",
    'pfi_items_desc' => "Type the name of a product to search your store. At least 3 characters are required for the search.",
);
